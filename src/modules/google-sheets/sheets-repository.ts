...
export async function getSheetDataRepository({ sheetId, sheetRange }: Sheet) {
  try {
...
export async function getSheetDatabyIdRepository({
  sheetId,
  sheetRange,
  sheetObjectId,
...
export async function appendSheetDataRepository({
  sheetId,
  sheetRange,
  sheetValues,
}: Sheet) {
...
export async function updateSheetDatabyIdRepository({
  sheetId,
  sheetRange,
  sheetObjectId,
  sheetValues,
  ...
  try {
    ...
    const { rowIndex } = await getSheetDatabyIdRepository({
      sheetId,
      sheetRange,
      sheetObjectId,
    });
...
export async function deleteRowFromSheetRepository({
  sheetId,
  sheetName,
  sheetRange,
  sheetObjectId,
